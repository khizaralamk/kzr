    ...
    <div className="w-full px-2 sm:px-4 max-w-xs md:max-w-2xl lg:max-w-5xl xl:max-w-7xl mx-auto">
      <div className="grid grid-cols-2 gap-4 md:gap-6 mb-6">
        ...
        <div className="flex flex-col gap-4 md:gap-6 -mt-6 md:-mt-12 min-w-0 ">
          ...
          <div className="aspect-square min-w-0 overflow-hidden relative">
            <img src="https://res.cloudinary.com/dfgr1deco/image/upload/f_auto,q_auto,w_800,dpr_auto,c_fill,g_auto,fl_progressive/samples/people/jazz.jpg" alt="Gallery 3" className="w-full h-full object-cover hover:scale-125 transition-transform duration-500" />
            <span className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-white/95 backdrop-blur-sm text-black px-2 py-1 sm:px-3 sm:py-1.5 text-xs sm:text-sm font-medium rounded-full z-10 text-center">Photography</span>
          </div>
          <div className="flex-1 min-w-0 overflow-hidden relative">
            ...
            <span className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-white/95 backdrop-blur-sm text-black px-2 py-1 sm:px-3 sm:py-1.5 text-xs sm:text-sm font-medium rounded-full z-10 text-center">UI/UX</span>
          </div>
        </div>
        {/* Second column */}
        <div className="flex flex-col gap-4 md:gap-6 min-w-0">
          <div className="aspect-square min-w-0 overflow-hidden relative">
            ...
            <span className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-white/95 backdrop-blur-sm text-black px-2 py-1 sm:px-3 sm:py-1.5 text-xs sm:text-sm font-medium rounded-full z-10 text-center">Branding</span>
          </div>
          <div className="aspect-square min-w-0 overflow-hidden relative">
          ...
          <div className="aspect-square min-w-0 overflow-hidden relative">
            ...
            <span className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-white/95 backdrop-blur-sm text-black px-2 py-1 sm:px-3 sm:py-1.5 text-xs sm:text-sm font-medium rounded-full z-10 text-center">Creative</span>
          </div>
        </div>
      </div>
