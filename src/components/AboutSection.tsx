      ...
      <div className="w-full max-w-7xl mx-auto ">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="md:max-w-2xl lg:max-w-5xl xl:max-w-7xl mx-auto space-y-16">
            ...
            <div 
              ref={titleRef}
              className={`space-y-4 mb-12 text-right fade-in-left ${titleVisible ? 'visible' : ''}`}
            >
            ...
            <div 
              ref={contentRef}
              className={`space-y-8 fade-in ${contentVisible ? 'visible' : ''}`}
            >
            ...
            <div 
              ref={statsRef}
              className={`pt-8 fade-in-up ${statsVisible ? 'visible' : ''}`}
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 max-w-4xl mx-auto">
                <div className="text-center space-y-2 stagger-1">
                ...
                <div className="text-center space-y-2 stagger-2">
                ...
                <div className="text-center space-y-2 stagger-3">
